...
stat
dfflibmap -liberty techmapping/tigfet/sclib_tigfet10_hpnw_all_tt_0p70v_25c.lib
opt
abc -D 10 \
    -script techmapping/tigfet/abc.script \
    -liberty techmapping/tigfet/sclib_tigfet10_hpnw_all_tt_0p70v_25c.lib \
    -constr techmapping/tigfet/sclib_tigfet10_hpnw_all_tt_0p70v_25c.abc.constr
setundef -zero
splitnets
opt_clean -purge
check
