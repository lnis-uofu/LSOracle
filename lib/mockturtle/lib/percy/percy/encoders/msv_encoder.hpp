                ...
                for (int i = 0; i < spec.nr_steps - 1; i++) {
                    ...
                    do {
                        ...
                        for (int k = 0; k < nr_svars_for_i; k++) {
                            if (bitmask[k]) {
                                pLits[fanin_ctr] = abc::Abc_Var2Lit(get_sel_var(spec, i, k), 1);
                        ...
                        do {
                            ...
                            for (int k = 0; k < nr_svars_for_ip; k++) {
                                if (bitmask_ip[k]) {
                                    pLits[spec.fanin + fanin_ctr] = abc::Abc_Var2Lit(get_sel_var(spec, i + 1, k), 1);
                ...
                for (int i = 0; i < spec.nr_steps - 1; i++) {
                    ...
                    do {
                        ...
                        for (int k = 0; k < spec.fanin; k++) {
                            Vec_IntSetEntry(vLits, ctr++, abc::Abc_Var2Lit(get_sel_var(spec, i, fanin[k]), 1));
                            Vec_IntSetEntry(vLits, ctr++, abc::Abc_Var2Lit(get_sel_var(spec, i + 1, fanin[k]), 1));
                        }
                ...
                for (int q = 1; q < spec.get_nr_in(); q++) {
                    for (int p = 0; p < q; p++) {
                        ...
                        for (int i = 0; i < spec.nr_steps; i++) {
                            ...
                            abc::Vec_IntSetEntry(vLits, 0, abc::Abc_Var2Lit(svar_p, 0));
                            abc::Vec_IntSetEntry(vLits, 1, abc::Abc_Var2Lit(svar_q, 1));

                            auto ctr = 2;
                            for (int ip = 0; ip < i; ip++) {
                                const auto ip_svar_p = get_sel_var(spec, ip, p);
                                abc::Vec_IntSetEntry(vLits, ctr++, abc::Abc_Var2Lit(ip_svar_p, 0));
                            }
