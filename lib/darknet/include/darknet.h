...
LIB_API void predict_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int top);
...
LIB_API void hierarchy_predictions(float *predictions, int n, tree *hier, int only_leaves);
LIB_API float sec(clock_t clocks);
// http_stream.h
